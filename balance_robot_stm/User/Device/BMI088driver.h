...
// 需手动修改
#define GxOFFSET 0.00214063493f
#define GyOFFSET -0.00385112641f
#define GzOFFSET 0.00257792417f
#define AxOFFSET 0.70818609f
#define AyOFFSET -0.0875423849f
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.64317989f
#define BMI088TEMPOFFSET 30.375
