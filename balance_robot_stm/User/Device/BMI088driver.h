...
// 需手动修改
#define GxOFFSET 0.00110218918f
#define GyOFFSET -0.00565269776f
#define GzOFFSET 0.00282116514f
#define AxOFFSET 0.709588766f
#define AyOFFSET -0.110911787f
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.64975071f
#define BMI088TEMPOFFSET 35.625
