...
// 需手动修改
#define GxOFFSET 0.00144892978f
#define GyOFFSET -0.00696069468f
#define GzOFFSET 0.00287513598f
#define AxOFFSET -0.149370313f
#define AyOFFSET -0.00163330138f
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.69678688f
#define BMI088TEMPOFFSET 40.25
